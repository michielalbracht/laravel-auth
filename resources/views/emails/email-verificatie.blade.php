          ...
          <tr>
            <td style="padding:32px;">
              ...
              <p style="margin:0 0 24px;font-size:15px;color:#6b7280;line-height:1.6;">
                Welkom bij {{ $appName }}! Bevestig je e-mailadres om volledig gebruik te maken van het platform.
              </p>
              <table cellpadding="0" cellspacing="0" style="margin:0 auto 24px;">
                <tr>
                  <td style="background:#6366f1;border-radius:8px;">
                    <a href="{{ $verificatieUrl }}" style="display:inline-block;padding:12px 28px;font-size:15px;font-weight:600;color:#ffffff;text-decoration:none;">
              ...
              <p style="margin:0 0 8px;font-size:13px;color:#9ca3af;line-height:1.6;">
                Deze link is 24 uur geldig. Als je geen account hebt aangemaakt bij {{ $appName }}, kun je deze e-mail negeren.
              </p>
              <p style="margin:0;font-size:12px;color:#d1d5db;word-break:break-all;">
                Of kopieer deze URL: {{ $verificatieUrl }}
              </p>
            </td>
          </tr>
          <!-- Footer -->

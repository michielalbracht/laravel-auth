          ...
          <tr>
            <td style="padding:32px;">
              ...
              <p style="margin:0 0 24px;font-size:15px;color:#6b7280;line-height:1.6;">
                Je hebt een verzoek ingediend om je wachtwoord opnieuw in te stellen. Klik op de knop hieronder om een nieuw wachtwoord te kiezen.
              </p>
              ...
              <p style="margin:0 0 8px;font-size:13px;color:#9ca3af;line-height:1.6;">
                Deze link is 60 minuten geldig. Als je geen wachtwoordherstel hebt aangevraagd, kun je deze e-mail negeren.
              </p>
              <p style="margin:0;font-size:12px;color:#d1d5db;word-break:break-all;">
                Of kopieer deze URL: {{ $resetUrl }}
              </p>
            </td>
          </tr>
          <!-- Footer -->
